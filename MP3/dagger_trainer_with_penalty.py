...
def dagger_trainer(env, learner, query_expert, device, num_iters=30, episodes_per_iter=10, max_steps=200):
    ...
    action_change_penalty = 0.05  # Penalty for changing actions
    # Removed action persistence
    ...
    plt.title("DAgger Policy Learning Progress (With Penalty Only)")
    plt.grid(True)
    plt.savefig("dagger_progress_penalty_only.png")
    print("✅ Saved reward plot to dagger_progress_penalty_only.png")