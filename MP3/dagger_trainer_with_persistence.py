...
def dagger_trainer(env, learner, query_expert, device, num_iters=30, episodes_per_iter=10, max_steps=200):
    ...
    plt.title("DAgger Policy Learning Progress (With Persistence Only)")
    plt.grid(True)
    plt.savefig("dagger_progress_persistence_only.png")
    print("✅ Saved reward plot to dagger_progress_persistence_only.png")